...
function PopularMovies() {
  ...
  return (
    <section className="mt-16 sm:mt-20 lg:mt-24 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div ref={sliderRef} className=" flex gap-4 sm:gap-6 overflow-x-auto scroll-smooth scrollbar-hide snap-x snap-mandatory pb-2 ">
        {popular.map((movie) => (
